...
- **Weather Forecast**: View weather information for your city.
- **Dynamic Background**: The app background changes according to the weather conditions (sunny, cloudy, or stormy).
- **Last Seen Weather**: Automatically saves and displays the last searched weather.
- **Search for Cities**: Enter a city name to get real-time weather information.
...
- **Weather API (RapidAPI)**: For real-time weather data.
